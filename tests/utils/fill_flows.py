...
def open_fill_page_with_level_reset(driver, base_url, email, password, level):
...
def enter_review_mode(driver, num_of_completed, num_of_incomplete):
    """Complete the requested mix of quizzes so the session enters review mode. (Available in TEST set only)"""
